...
namespace CarRentalSysteme
{
    public partial class AddEditRentalRecord : Form
    {
        ...
        {
            tbCustomerName.Text = recordToEdit.CostamerName;
            dtRented.Value = (DateTime)recordToEdit.dateRented;
            dtReturned.Value = (DateTime)recordToEdit.dateRenturnd;
            tbCost.Text = recordToEdit.coste.ToString();
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isValid)
                {
                    ...
                    rentalRecord.CostamerName = customerName;
                    rentalRecord.dateRented = dateOut;
                    rentalRecord.dateRenturnd = dateIn;
                    rentalRecord.coste = (decimal)cost;
                    rentalRecord.Typeofcars = (int)cbTypeOfCar.SelectedValue;
